...
class HardNegativeTripletSampler:
    ...
    def __init__(
        ...
        Args:
          ...
          num_triplets: Triplets pro Epoche
        ...
        # Liste aller Patienten => embedding
        ...
        with torch.no_grad():
            for i, row in self.df.iterrows():
                ...
                self.patient_info_list.append({
                    ...
                    'study_yr': sy,
                    'combo': combo,
                    'multi_label': multi_label_vec,
                    'embedding': emb
                })

        # In combo_dict => combo_str -> Liste von patient_info
        self.combo_dict = {}
        ...
        # Erstellen einer Liste (N,d) => Distanzberechnung
    ...
    def __iter__(self):
        ...
        Hard Negative => min. Distanz(Anchor, Negative) wird gesucht
        ...
        while count < self.num_triplets and attempts < max_attempts:
            ...
            # Wähle Hard Negative: => Distmatrix => sort ascending => nimmt den index des 1. patients, der NICHT anchor_combo hat
