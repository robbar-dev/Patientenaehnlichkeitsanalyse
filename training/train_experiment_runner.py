...
def main():
    ...
    # Pfade definieren:
    TRAIN_CSV = r"C:\Users\rbarbir\OneDrive - Brainlab AG\Dipl_Arbeit\Datensätze\head_vs_lung\training\nlst_subset_v5_head_vs_lung_training.csv"
    VAL_CSV   = r"C:\Users\rbarbir\OneDrive - Brainlab AG\Dipl_Arbeit\Datensätze\head_vs_lung\val\nlst_subset_v5_head_vs_lung_val.csv"
    DATA_ROOT = r"D:\thesis_robert\test_data_folder\head_vs_lung"

    # Liste von Experiment-Konfigurationen
    experiments = [
      {
        "exp_name": "MMM_Exp17_max",
        "train_csv": TRAIN_CSV,
        "val_csv":   VAL_CSV,
        "data_root": DATA_ROOT,
