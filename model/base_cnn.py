...
if __name__ == "__main__":
    ...
    # Beispiel 1: ResNet50, pretrained, freeze_blocks=[0,1] => layer1 + layer2
    model_frozen_r50 = BaseCNN(
        model_name='resnet50',
        pretrained=True,
        freeze_blocks=[0,1]
    )
    print("Teil-gefrorenes ResNet50 (layer1, layer2):")
    print(model_frozen_r50)
    out_r50 = model_frozen_r50(dummy_input)
    print("Output shape ResNet50:", out_r50.shape)  # (2, 2048)

    # Beispiel 2: ResNet18, komplett trainierbar
    model_unfrozen_r18 = BaseCNN(
        model_name='resnet18',
        pretrained=True,
        freeze_blocks=None
    )
    print("\nVoll trainierbares ResNet18:")
    print(model_unfrozen_r18)
    out_r18 = model_unfrozen_r18(dummy_input)
    print("Output shape ResNet18:", out_r18.shape)  # (2, 512)
